    ...
    describe('InvoiceLineItem Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/invoice-line-items';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a InvoiceLineItem', () => {
                service.create(new InvoiceLineItem(null)).subscribe(received => {
            ...
            it('should update a InvoiceLineItem', () => {
                service.update(new InvoiceLineItem(123)).subscribe(received => {
            ...
            it('should return a InvoiceLineItem', () => {
            ...
            it('should return a list of InvoiceLineItem', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new InvoiceLineItem(123)]);
            });
