...
public class InvoiceCriteria implements Serializable {
    ...
    private IntegerFilter invoiceNumber;

    private LocalDateFilter invoiceDate;

    private StringFilter customerName;

    private IntegerFilter invoiceAmount;
    ...
    public IntegerFilter getInvoiceNumber() {
        return invoiceNumber;
    }

    public void setInvoiceNumber(IntegerFilter invoiceNumber) {
    ...
    public IntegerFilter getInvoiceAmount() {
        return invoiceAmount;
    }

    public void setInvoiceAmount(IntegerFilter invoiceAmount) {
